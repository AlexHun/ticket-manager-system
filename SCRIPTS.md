...
| `bun run tokens`      | forecast vs. actual token spend per ticket, from the local Claude Code transcripts — reads nothing in this repo and writes nothing anywhere |

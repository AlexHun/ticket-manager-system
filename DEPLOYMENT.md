...
| `DEMO_SESSIONS_PER_IP_PER_HOUR`                | `5`                          | Demo sessions one client address may start per hour, keyed like the sign-in rate limit. The sixth is refused and creates nobody. In memory: a restart forgets the hour.                                                |

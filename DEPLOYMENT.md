...
| `DEMO_AI_DAILY_USD`                            | `1.00`                       | What all demo sessions together may spend on AI per UTC day (estimated). Once reached, demo polish and summarise make no call until 00:00 UTC; admins are never counted.                                               |

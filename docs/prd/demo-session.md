...
| R3  | A demo session sees every screen an admin sees except Users and Outbox. Neither appears in the navigation; reaching either by link or typed URL shows the not-found page, and the API refuses their data to a demo session. | Must     |
